...
let constant dir s =
  ...
  try
    EConstr.of_constr (UnivGen.constr_of_global (global_reference_in_absolute_module dir id))
  with Not_found ->
...
let stal_constant dir s =
  let id = Id.of_string s in
  try
    EConstr.of_constr (UnivGen.constr_of_global (global_reference_in_absolute_module
