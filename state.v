...
Hint Resolve eqStateRzRef eqStateRzIn eqStateRzInv : stalmarck.
...
Qed.
Hint Resolve eqStateContrSimpl1 : stalmarck.
Hint Immediate eqStateRzSym eqStateInvInv : stalmarck.

(* Adding an equation to a state *)

Definition addEq (p : rZ * rZ) (S : State) : State := p :: S.
Hint Unfold addEq : stalmarck.
...
Qed.
Hint Resolve eqStateaddEq1 eqStateaddEq2 : stalmarck.
...
Qed.
Hint Resolve inclStateRef : stalmarck.
(*Simpler version *)
...
Qed.
Hint Resolve addEqInclState : stalmarck.
...
Qed.
Hint Resolve addEqInclState2 : stalmarck.
...
Qed.
Hint Resolve inclStateAddEqInv : stalmarck.
...
auto with stalmarck.
Qed.
Hint Resolve inclStateAddEq : stalmarck.
...
intros S1 S2 a b H'; inversion H'; red in |- *; auto with stalmarck.
Qed.
Hint Resolve eqStateAddEq : stalmarck.
...
apply eqStateRzTrans with (b := b); auto with stalmarck.
Qed.
Hint Resolve addEqComp : stalmarck.
...
intros i j H'; elim H'.
Qed.
Hint Resolve realizeStateNil : stalmarck.
...
Qed.
Hint Resolve realizeStateAddEq : stalmarck.
...
apply realizeStateInv with (S := S); auto with stalmarck.
Qed.
Hint Resolve contradictoryNotRealize : stalmarck.
...
Qed.
Hint Resolve ContrIncl : stalmarck.
